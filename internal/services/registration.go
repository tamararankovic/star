...
import (
	...
	domain2 "github.com/c12s/star/internal/domain"
...
type RegistrationService struct {
	api        domain2.RegistrationAPI
	nodeIdRepo domain2.NodeIdRepo
	nodeIdChan chan string
	maxRetries int8
}

func NewRegistrationService(api domain2.RegistrationAPI, nodeIdRepo domain2.NodeIdRepo, nodeIdChan chan string, maxRetries int8) *RegistrationService {
...
func (rs *RegistrationService) tryRegister() error {
	...
	return rs.nodeIdRepo.Put(domain2.NodeId{Value: resp.NodeId})
}
